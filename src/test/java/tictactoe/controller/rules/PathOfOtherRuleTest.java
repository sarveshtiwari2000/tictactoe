...
public class PathOfOtherRuleTest {
    private final PathOfOtherRule pathOfOtherRule = new PathOfOtherRule();

    @Test
    public void pathOfOtherRule() {
        ...
        pathOfOtherRule.executeLevel(new Player('O'), paths);
